...
public class IndicatorView extends LinearLayout {
    ...
    public void initIndicator(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                v.setBackgroundResource(R.mipmap.dot_selected);
            } else {
                v.setBackgroundResource(R.mipmap.dot_unselected);
            }
            mImageViews.add(v);
            this.addView(v);
        }
    ...
    public void playByStartPointToNext(int startPosition, int nextPosition) {
        ...
        ViewNext.setBackgroundResource(R.mipmap.dot_selected);
        ViewStrat.setBackgroundResource(R.mipmap.dot_unselected);
    }
